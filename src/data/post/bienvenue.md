...
excerpt: Une première note pour ouvrir l'espace. Ce site est un cahier ouvert sur ce que je construis et ce que j'apprends à la frontière du digital et du réel.
...
tags:
  ...
  - portfolio
metadata:
  canonical: https://martin.nuagegreen.eu/articles/bienvenue
---

Premier article — un peu méta, mais utile pour poser le décor.

## Pourquoi ce site

J'écris cette première note depuis Paris, le 29 avril 2026. Ce site sert plusieurs choses à la fois :

- **Une vitrine** quand quelqu'un me demande "tu fais quoi exactement ?" — c'est plus fluide qu'un CV PDF.
- **Un carnet** où je dépose les choses longues sur ce que je construis (homelab, agents IA, apps perso, side-projects 3D).
...
À plus long terme, des notes sur la robotique DIY, l'impression 3D appliquée, et probablement un retour d'expérience sur le concept de "cockpit de vie" (piloter sa vie avec des indicateurs comme on pilote un avion).
